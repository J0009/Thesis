...
<body style="font-family: calibri; font-size: 19.5px;" class="body"><form name="form1" action="#" method="post">
	...
	<img src="img/PSU.png" width="7%" height="7%" align="left"><input type="file" name="" style="float: right;">
	<center>
	<span style="font-size: 20px;"">
		<b>APPLICATION FORM FOR COLLEGE ADMISSION TEST</b><br>
...
<table>
	...
	<tr>
		...
		<td><input type="text" name="fathername" style="width: 100%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
		<td><input type="text" name="mothername" style="width: 80%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
	</tr>
	<tr>
		<td align="right">Address</td>
		<td><input type="text" name="fatheradd" style="width: 100%"></td>
		<td></td>
		<td><input type="text" name="motheradd" style="width: 80%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
	</tr>
	<tr>
		<td align="right">Contact Number</td>
		<td><input type="number" name="fathernum" style="width: 100%"></td>
		<td></td>
		<td><input type="number" name="mothernum" style="width: 80%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
	</tr>
	<tr>
		<td align="right">Occupation</td>
		<td><input type="text" name="fatherwork" style="width: 100%"></td>
		<td></td>
		<td><input type="text" name="motherwork" style="width: 80%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
	</tr>
	<tr>
		<td align="right">Educational Attainment</td>
		<td><input type="text" name="fathereduc" style="width: 100%"></td>
		<td></td>
		<td><input type="text" name="mothereduc" style="width: 80%"></td>
		<td><?php $x=130; include("nb.php"); ?></td>
	</tr>
	<tr>
		<td align="right">Guardian's Name</td>
		<td><input type="text" name="guardian" style="width: 100%"></td><td></td>
	...
	<tr>
		...
		<td><input type="text" name="hs" style="width: 100%"></td><td></td>
		<td>Year Graduated <input type="number" name="yeargrad" style="width: 20%">
			&nbsp;&nbsp;&nbsp;&nbsp;General Average <input type="number" name="genave" style="width: 20%" min="75">%</td>
	</tr>
	<tr>
	...
	<tr id="showMe" style="display: none;">
		...
		<td><span>Attended Last 
			...
			</select> Sem, School Year <input type="number" name="schoolYear" style="width: 8%"></span>
			&nbsp;&nbsp;&nbsp;<span>
			...
			Year, <input type="name" name="course" style="width: 20%;"> Course</span></td>
	</tr>
</table>
<div>
	1<sup>st</sup> choice 
	<select name="first">
		<?php
	        ...
	        if ($res->num_rows > 0) {
	            ...
	            echo "<option value=".$row['alaminos'].">".$row['alaminos']."</option>";
	          }
	        }
		?>
	</select>
...
// insert function
  ...
  values('$lname', '$fname', '$mname', '$add', '$bday', '$bplace', '$rel','$sex', '$st', '$studtype', '$citez', '$num','$sname', '$snum', '$faname', '$moname', '$fadd', '$madd', '$fnum', '$mnum', '$fwork','$mwork', '$feduc', '$meduc', '$gname', '$grel','$gadd', '$gnum', '$sibling', '$hs', '$hsyr', '$genave', '$shs', '$college', '$sem', '$sy', '$yrlvl', '$crs', '$first', '$second', '$third', CURRENT_TIMESTAMP, 'alaminos')";

	...
	<select name="first">
		<?php
	        ...
	        if ($res->num_rows > 0) {
	            ...
	            echo "<option value=".$row['urdaneta'].">".$row['urdaneta']."</option>";
	          }
	        }
		?>
	</select>
...
// insert function
  ...
  values('$lname', '$fname', '$mname', '$add', '$bday', '$bplace', '$rel','$sex', '$st', '$studtype', '$citez', '$num','$sname', '$snum', '$faname', '$moname', '$fadd', '$madd', '$fnum', '$mnum', '$fwork','$mwork', '$feduc', '$meduc', '$gname', '$grel','$gadd', '$gnum', '$sibling', '$hs', '$hsyr', '$genave', '$shs', '$college', '$sem', '$sy', '$yrlvl', '$crs', '$first', '$second', '$third', CURRENT_TIMESTAMP, 'urdaneta')";
